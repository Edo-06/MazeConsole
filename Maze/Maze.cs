...
namespace maze
{
    class Maze
    {
        ...
        public Cell[,] mazee;
        private List<int> obstacleTypes = [];
        ...
        public void Generator(int mazesize)
        {
            ...
            mazee[usedcells[0][0], usedcells[0][1]].category = Category.path; 
            int[] cell;
            ...
            while (usedcells.Count > 0)
            {
                ...
                if (neighbords.Count > 0)
                {
                    ...
                    mazee[newrow, newcol].category = Category.path;
                    
                    mazee[(row + newrow) / 2, (col + newcol) / 2].category = Category.path;
        ...
        private void ValidatePosition(int row, int col, Category category )
        {
            ...
            mazee[row, col + 1].category == Category.path && mazee[row, col - 1].category == Category.path) ||
            (mazee[row + 1, col].category == Category.path && mazee[row - 1, col].category == Category.path && 
